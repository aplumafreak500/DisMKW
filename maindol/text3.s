...
Codehandler_Start:
	...
	.ifndef CODEHANDLERONLY
	bl	_codehandler
_setvalues:
	#lis	r31,Codehandler_Start@h		#0x8000
	li	r21,0
	li	r22,0x19
	li	r23,0xD0
	lis	r24,0xCD00
...
_executebp:
	...
	bl	Codehandler_Start	# bl mainloop, so you can set up a new breakpoint.
_skipbp:
	mfmsr	r1
...
sendcheats:
	...
	bl	exireceivebuffer
	lwz	r16, 0(r12)
	lis r12, GCT_Codelist@h
	ori	r12, r12, GCT_Codelist@l
	b	upload
...
_codehandler:
	mflr	r29
	lis r15, GCT_Codelist@h
	ori	r15, r15, GCT_Codelist@l
...
_conditional:
	...
	.global _conditional32
_conditional32:
	rlwinm	r12,r12,0,0,29		#32bits align
	lwz	r11,0(r12)
	b	_condition_sub
	.global _conditional16
_conditional16:
